...
export const AppConfig: Environment = {
  loginUrl: 'https://marathon.auth.us-east-1.amazoncognito.com/login?response_type=token&client_id=b230eteev0qvv3r73ufhv4o3b&redirect_uri=http://localhost:3000/login',
